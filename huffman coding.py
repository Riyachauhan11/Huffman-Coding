...
class HuffmanCoding:
    ...
    def __getPaddedEncodedText(self,encoded_text):
        ...
        #08 represents 8 bits and b represents the conversion to binary
    ...
    def compress(self):
        ...
        with open(self.path,'r+') as file, open(output_path,'wb') as output:
            ...
            #construct the min heap (consisting of binary tree nodes) from frequency dictionary
            ...
            #Creating the ecoded text using the codes
            encoded_text=self.__getEncodedText(text)

            #put this ecoded text into the binary file

            #pad this encoded text
            padded_encoded_text=self.__getPaddedEncodedText(encoded_text)

            #obtain an array of bytes from the padded encoded text we have stored
    ...
    def decompress(self,input_path):
        ...
        with open(input_path,'rb') as file,open(output_path,'w')as output:
            bit_string=""
            #wont get int/str from here directly
            byte=file.read(1)
            while byte:
                #gets int/str
                byte=ord(byte)
                #conversion to binary and making it of length 8
...
path='C:/Users/Riya Chauhan/Desktop/yes.txt'
